...
export default function EmailVerified() {
    ...
    return (
        <div className="container w-full mx-auto flex flex-row border border-gray-300 p-3 rounded mt-4 justify-between align-center">
            <Typography className="text-orange-500">Did you verified your email?</Typography>
            <div className="flex flex-row align-center">
                <Button href={"/auth/login?prompt=login&returnTo=/my-profile"} variant="contained" className="button cursor-pointer !no-underline text-center !me-2">YES</Button>
