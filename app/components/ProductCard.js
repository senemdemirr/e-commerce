    ...
    return(
        <div className="bg-white cursor-pointer rounded-2xl shadow-md hover:shadow-xl transition flex flex-col overflow-hidden border border-gray-100">
            <div className="relative">
                ...
                />
                <span className="absolute top-2 left-2 bg-blue-600 text-white text-xs px-2 py-0.5 rounded">{product.category}</span>
            </div>
            <div className="flex-1 flex flex-col px-4 py-3 gap-1">
                ...
                <span className="text-xl font-bold text-blue-600">{product.price} <span className="text-base font-medium">{product.currency}</span></span>
