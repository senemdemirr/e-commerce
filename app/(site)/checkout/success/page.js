...
function OrderSuccessContent() {
    ...
    return (
        <main className="flex flex-col items-center justify-center py-12 px-4 text-center max-w-[640px] mx-auto">
            ...
            <div className="w-full flex flex-col items-stretch justify-start rounded-xl shadow-[0_10px_30px_rgba(0,0,0,0.05)] bg-white dark:bg-surface-dark overflow-hidden border border-[#f1f3f2] dark:border-gray-800">
                <div
            ...
            <div className="w-full mt-12 flex flex-col sm:flex-row flex-1 gap-4 px-0  py-3 justify-center">
                <button
                    onClick={() => router.push('/')}
