...
export function normalizeProductRow(row, options = {}) {
    ...
    if (Object.prototype.hasOwnProperty.call(row, 'review_count')) {
        normalized.review_count = Number(row.review_count || 0);
    }

    if (Object.prototype.hasOwnProperty.call(row, 'average_rating')) {
        normalized.average_rating = Number(row.average_rating || 0);
    }
